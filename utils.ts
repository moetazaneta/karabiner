...
/**
 * Shortcut for "Quit an app" command (of which there are a bunch)
 */
export function quit(name: string): LayerCommand {
	return {
		to: [
			{
				shell_command: `osascript -e 'quit app "${name}"'`,
			},
		],
